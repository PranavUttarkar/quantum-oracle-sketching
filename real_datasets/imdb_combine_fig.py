...
def main():
    ...
    if args.mode in ("bucket", "bucket_jl"):
        ...
        if args.mode == "bucket_jl":
            if args.jl_accuracy_json is None:
                args.jl_accuracy_json = "imdb_jl_size_vs_accuracy.json"
            if args.jl_variance_json is None:
                args.jl_variance_json = "imdb_jl_size_vs_variance.json"
    elif args.mode == "jl":
        if args.accuracy_json is None:
            args.accuracy_json = "imdb_jl_size_vs_accuracy.json"
        if args.variance_json is None:
            args.variance_json = "imdb_jl_size_vs_variance.json"
    else:
        if args.accuracy_json is None:
    ...
    if args.out is None:
        if args.mode == "bucket":
            args.out = "imdb_bucket_combine.pdf"
        elif args.mode == "bucket_jl":
            args.out = "imdb_bucket_jl_combine.pdf"
        elif args.mode == "jl":
            args.out = "imdb_jl_combine.pdf"
        else:
            args.out = "imdb_combine.pdf"
